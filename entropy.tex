...
In the field of soil carbon cycle modeling, \citet{Agren2021BGC} recently applied the maximum entropy principle to identify the distribution of soil carbon qualities with·in the framework of the continuous-quality theory.
