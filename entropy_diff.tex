...
%DIF DEL entropy.tex      Tue Oct 18 15:44:00 2022
%DIF ADD entropy_v2.tex   Wed Jul 19 11:19:01 2023
...
Age and transit time \DIFaddbegin \DIFadd{of material content in compartmental systems  }\DIFaddend are two diagnostic metrics \DIFdelbegin \DIFdel{of compartmental systems }\DIFdelend that have been widely studied for systems in and out of equilibrium \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Eriksson1971ARoEaS, Bolin1973tellus, Rasmussen2016JMB, Sierra2016GlobChangBiol, Metzler2018MGS, MetzlerMuellerSierra2018PNAS}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Eriksson1971ARoEaS, Bolin1973tellus, Rasmussen2016JMB, Sierra2017GCB, Metzler2018MGS, MetzlerMuellerSierra2018PNAS}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
\end{equation}
It can be shown \citep[Sect.~3.2]{Metzler2018MGS} that the mean or expected value of $\TT$ equals the turnover time \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Sierra2016GlobChangBiol} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Sierra2017GCB} }\hspace{0pt}%DIFAUXCMD
...
We now define the \emph{path entropy \DIFaddbegin \DIFadd{of the compartmental system}\DIFaddend } \DIFdelbegin \DIFdel{of the compartmental system }\DIFdelend $M$ in equilibrium \DIFdelbegin \DIFdel{, }\DIFdelend given by Eq.~\eqref{eqn:lin_CS_sys} \DIFdelbegin \DIFdel{, as the path entropy of its associated }\DIFdelend \DIFaddbegin \DIFadd{with associated absorbing }\DIFaddend continuous-time Markov chain $X$ \DIFdelbegin \DIFdel{, \ie
}\DIFdelend \DIFaddbegin \DIFadd{and path $\mathcal{P}=\mathcal{P}(X)$, as the path entropy 
...
%DIF >        \midrule
        \hline
         \input{figs/Compartments/onepool.tex} & \DIFaddFL{$-\lambda x +1$ }& \DIFaddFL{$0.5 \ (1 - \log \lambda)$ }& \DIFaddFL{2.00 }& \DIFaddFL{$\lambda (1 - \log \lambda)$ }& \DIFaddFL{$1/ \lambda$ }& \DIFaddFL{$1 - \log$ }\\
         \input{figs/Compartments/twoseries.tex}    & \DIFaddFL{%
\mbox{%DIFAUXCMD
$\left( \begin{matrix} -1 & 0 \\ 1 & -1  \end{matrix} \right) x + \left( \begin{matrix} 1 \\ 0 \end{matrix} \right)$
         ...
         \input{figs/Compartments/twoparallel.tex}  & \DIFaddFL{%
\mbox{%DIFAUXCMD
$\left( \begin{matrix} -1 & 0 \\ 0 & -1  \end{matrix} \right) x + \left( \begin{matrix} 1 \\ 1 \end{matrix} \right)$
         ...
         \input{figs/Compartments/twofeedback1.tex}  & \DIFaddFL{%
\mbox{%DIFAUXCMD
$\left( \begin{matrix} -1 & 1/2 \\ 1 & -1  \end{matrix} \right) x + \left( \begin{matrix} 1 \\ 0 \end{matrix} \right)$
         ...
         \input{figs/Compartments/twofeedback2.tex}   & \DIFaddFL{%
\mbox{%DIFAUXCMD
$\left( \begin{matrix} -1 & 1/2 \\ 1/2 & -1  \end{matrix} \right) x + \left( \begin{matrix} 1 \\ 1 \end{matrix} \right)$
         ...
         \input{figs/Compartments/threeseries.tex}   & \DIFaddFL{%
\mbox{%DIFAUXCMD
$\left( \begin{matrix} -1 & 0 & 0 \\ 1 & -1 & 0 \\ 0 & 1 & -1 \end{matrix} \right) x + \left( \begin{matrix} 1 \\ 0 \\ 0 \end{matrix} \right)$
         ...
         \input{figs/Compartments/threeparallel.tex}   & \DIFaddFL{%
\mbox{%DIFAUXCMD
...
\begin{figure}[htbp]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{figs/EmanuelModelStructure.pdf}
%DIFDELCMD <   %%%
...
\begin{figure}[htbp]
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.5\linewidth]{figs/Wang_model_srm_with_fluxes.png}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{figs/Wang_model_srm_with_fluxes.png}
    \DIFaddendFL \caption{
...
\DIFdel{results in the same transfer function, but a different }\DIFdelend \DIFaddbegin \DIFadd{, we can clearly see that it is a good candidate.
	...
	\begin{figure}[ht]
    \centering
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.95\linewidth]{figs/optimization.png}
%DIFDELCMD < 		%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.95\linewidth]{figs/model_id.png}
	\DIFaddendFL \caption{
